...
// //             Transaction ID
// //           </Typography>
// //           <Typography variant="body1">{transaction._id}</Typography>
// //         </Box>
...
//                 Buyer ID
//               </Typography>
//               <Typography variant="body1">{metadata.buyerId}</Typography>
//             </Grid>
//           )}
//           {metadata.userEmail && (
//             <Grid item xs={6}>
...
//                 User Email
//               </Typography>
//               <Typography variant="body1">{metadata.userEmail}</Typography>
//             </Grid>
//           )}
//           {metadata.tierName && (
//             <Grid item xs={6}>
...
//                 Tier Name
//               </Typography>
//               <Typography variant="body1">{metadata.tierName}</Typography>
//             </Grid>
//           )}
//           {metadata.tierType && (
//             <Grid item xs={6}>
...
//                 Tier Type
//               </Typography>
//               <Typography variant="body1">{metadata.tierType}</Typography>
//             </Grid>
//           )}
...
//                 Lead ID
//               </Typography>
//               <Typography variant="body1">{metadata.leadId}</Typography>
//             </Grid>
//           )}
...
//                 Units Purchased
//               </Typography>
//               <Typography variant="body1">{metadata.unitsPurchased}</Typography>
//             </Grid>
//           )}
...
//                 Seller ID
//               </Typography>
//               <Typography variant="body1">{metadata.sellerId}</Typography>
//             </Grid>
//           )}
//           {metadata.payoutId && (
//             <Grid item xs={6}>
...
//                 Payout ID
//               </Typography>
//               <Typography variant="body1">{metadata.payoutId}</Typography>
//             </Grid>
//           )}
...
//                 Refund Reason
//               </Typography>
//               <Typography variant="body1">{metadata.refundReason}</Typography>
//             </Grid>
//           )}
...
//                 Admin Note
//               </Typography>
//               <Typography variant="body1">{metadata.adminNote}</Typography>
//             </Grid>
//           )}
//         </Grid>
//       </>
