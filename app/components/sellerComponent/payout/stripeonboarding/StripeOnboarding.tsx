...
//   // Handle both success and restart cases
//   useEffect(() => {
...
//         .
//       </p>
//       {accountStatus?.tosAccepted === false && (
//         <div className="warning-message">
//           You need to accept our Terms of Service to continue.
//         </div>
//       )}
//     </div>
//   );
...
//       ...accountStatus.requirements.eventuallyDue,
...
//         </div>
//       ) : (
//         <button onClick={createConnectedAccount} disabled={loading}>
...
//           </div>
//           <div className="status-item">
//             <strong>Charges Enabled:</strong> Yes
//           </div>
//           <div className="status-item">
//             <strong>Payouts Enabled:</strong> Yes
//           </div>
//         </div>
//       ) : (
//         <>
...
//             <div className="account-status">
//               <div className="status-item">
//                 <strong>Account Status:</strong> Not fully connected
//               </div>
//               {renderRequirements()}
//               <button
//                 onClick={() => (window.location.href = onboardingUrl || "#")}
